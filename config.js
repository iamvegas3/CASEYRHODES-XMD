...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Caseyrhodes~dDtglZ4L#yrmjnromaxv10WQsWUr8UPS5eCL6HqOssGAEaH0ePsY",
// add your Session Id 
PREFIX: process.env.PREFIX || ".",
// add your prifix for bot
BOT_NAME: process.env.BOT_NAME || "miggo",
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "254110995033",
// add your bot owner number
OWNER_NAME: process.env.OWNER_NAME || "miggo",
// add bot owner name
